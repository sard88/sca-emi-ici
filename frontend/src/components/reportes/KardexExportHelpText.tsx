export function KardexExportHelpText() {
  return (
    <section className="rounded-[1.5rem] border border-[#d8c5a7] bg-[#fffaf1] p-5 text-sm leading-6 text-[#5f4525] shadow-sm">
      ...
      <p className="mt-2">
        El PDF se genera en el backend desde el ServicioKardex y queda auditado como salida documental.
        El portal solo permite seleccionar discentes autorizados y disparar la descarga.
      </p>
      <p className="mt-2 font-semibold">
        El kárdex oficial no está disponible para discentes ni docentes, y la versión Excel queda pendiente para un bloque posterior.
      </p>
    </section>
  );
}
