...
export default function CatalogoResourceDetailPage() {
  ...
  return <CatalogResourcePage config={config} resourceId={params.id} backHref="/catalogos" canRead={canAccessCatalogos} canWrite={canWriteCatalogos} />;
}
