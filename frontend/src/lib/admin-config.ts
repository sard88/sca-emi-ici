...
export const adminResources: AdminCatalogResourceConfig[] = [
  {
    ...
    formFields: [
      ...
      { key: "grado_empleo_id", label: "Grado/empleo", type: "relation", relationEndpoint: "/api/admin/grados-empleos/", relationActiveOnly: true, relationSearchEnabled: true },
  ...
  },
  {
    ...
    formFields: [
      ...
      { key: "padre_id", label: "Unidad padre", type: "relation", relationEndpoint: "/api/admin/unidades-organizacionales/", relationActiveOnly: true, relationSearchEnabled: true },
      { key: "carrera_id", label: "Carrera", type: "relation", relationEndpoint: "/api/catalogos/carreras/", relationActiveOnly: true, relationSearchEnabled: true },
  ...
  },
  {
    ...
    formFields: [
      { key: "usuario_id", label: "Usuario", type: "relation", relationEndpoint: "/api/admin/usuarios/", relationQueryParams: { activo: true }, relationSearchEnabled: true, required: true },
      {
        key: "cargo_codigo",
        label: "Cargo",
        type: "select",
        options: [
          { value: "JEFE_ACADEMICO", label: "Jefatura académica" },
          { value: "JEFE_PEDAGOGICA", label: "Jefatura pedagógica" },
          { value: "JEFE_SUB_PLAN_EVAL", label: "Subsección de Planeación y Evaluación" },
          { value: "JEFE_SUB_EJEC_CTR", label: "Subsección de Ejecución y Control" },
      ...
      { key: "unidad_organizacional_id", label: "Unidad organizacional", type: "relation", relationEndpoint: "/api/admin/unidades-organizacionales/", relationActiveOnly: true, relationSearchEnabled: true },
      { key: "carrera_id", label: "Carrera", type: "relation", relationEndpoint: "/api/catalogos/carreras/", relationActiveOnly: true, relationSearchEnabled: true },
