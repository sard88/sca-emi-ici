...
export const dashboardProfiles: Record<string, DashboardProfile> = {
  admin: {
    ...
    cards: [
      ...
      { title: "Catálogos académicos", description: "Carreras, planes, periodos, grupos, materias base y esquemas.", href: "/catalogos" },
      { title: "Seguimiento institucional de actas", description: "Estados, cortes, validaciones y formalización desde el portal.", href: "/estadistica/actas" },
  ...
  estadistica: {
    ...
    cards: [
      ...
      { title: "Usuarios académicos", description: "Revisión operativa de usuarios institucionales autorizados.", href: "/administracion/usuarios" },
      { title: "Seguimiento de actas", description: "Revisión operativa de estados, cortes y exportaciones.", href: "/estadistica/actas" },
  ...
  discente: {
    ...
    cards: [
      ...
      { title: "Mis actas publicadas", description: "Resultados visibles y conformidad informativa.", href: "/discente/actas" },
  ...
  jefaturaAcademica: {
    ...
    description: "Formalización y seguimiento institucional de actas.",
  ...
  jefaturaPedagogica: {
    ...
    cards: [
      ...
      { title: "Auditoría de eventos críticos", description: "Eventos institucionales permitidos por perfil.", href: "/reportes/auditoria" },
      { title: "Catálogos académicos", description: "Estructura académica autorizada.", href: "/catalogos" },
    ],
  },
};
