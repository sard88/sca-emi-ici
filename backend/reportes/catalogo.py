...
CATALOGO_EXPORTACIONES = (
    ...
    ExportacionCatalogoItem(
        ...
        roles_sugeridos=tuple(sorted(ROLES_ADMIN | ROLES_ESTADISTICA | ROLES_JEFATURA_CARRERA | ROLES_JEFATURA_ACADEMICA | ROLES_JEFATURA_PEDAGOGICA)),
        bloque_origen="9E",
        nota="XLSX implementado en Bloque 9I-M-E. Documento interno; no sustituye kárdex oficial.",
    ),
    ExportacionCatalogoItem(
    ...
    ExportacionCatalogoItem(
        ...
        roles_sugeridos=tuple(sorted(ROLES_ADMIN | ROLES_ESTADISTICA | ROLES_JEFATURA_CARRERA | ROLES_JEFATURA_ACADEMICA | ROLES_JEFATURA_PEDAGOGICA)),
        bloque_origen="9I",
        nota="XLSX implementado en Bloque 9I-M-E para situación actual. PDF queda pendiente.",
    ),
    ExportacionCatalogoItem(
        codigo=RegistroExportacion.TIPO_REPORTE_EXTRAORDINARIOS,
        nombre="Extraordinarios registrados",
        descripcion="Seguimiento de extraordinarios, resultado oficial y marca EE.",
        formatos_soportados=(RegistroExportacion.FORMATO_XLSX,),
        implementado=True,
        requiere_objeto=False,
        roles_sugeridos=tuple(sorted(ROLES_ADMIN | ROLES_ESTADISTICA | ROLES_JEFATURA_CARRERA | ROLES_JEFATURA_ACADEMICA | ROLES_JEFATURA_PEDAGOGICA)),
        bloque_origen="9I",
        nota="XLSX implementado en Bloque 9I-M-E. No muestra matrícula militar por defecto.",
    ),
    ExportacionCatalogoItem(
        codigo=RegistroExportacion.TIPO_REPORTE_BAJAS_TEMPORALES,
        nombre="Bajas temporales",
        descripcion="Reporte nominal de eventos de baja temporal abiertos o cerrados.",
        formatos_soportados=(RegistroExportacion.FORMATO_XLSX,),
        implementado=True,
        requiere_objeto=False,
        roles_sugeridos=tuple(sorted(ROLES_ADMIN | ROLES_ESTADISTICA | ROLES_JEFATURA_CARRERA | ROLES_JEFATURA_ACADEMICA | ROLES_JEFATURA_PEDAGOGICA)),
        bloque_origen="9I",
        nota="XLSX implementado en Bloque 9I-M-E.",
    ),
    ExportacionCatalogoItem(
        codigo=RegistroExportacion.TIPO_REPORTE_BAJAS_DEFINITIVAS,
        nombre="Bajas definitivas",
        descripcion="Reporte nominal de eventos de baja definitiva.",
        formatos_soportados=(RegistroExportacion.FORMATO_XLSX,),
        implementado=True,
        requiere_objeto=False,
        roles_sugeridos=tuple(sorted(ROLES_ADMIN | ROLES_ESTADISTICA | ROLES_JEFATURA_CARRERA | ROLES_JEFATURA_ACADEMICA | ROLES_JEFATURA_PEDAGOGICA)),
    ...
    ExportacionCatalogoItem(
        codigo=RegistroExportacion.TIPO_REPORTE_REINGRESOS,
        nombre="Reingresos",
        descripcion="Reporte de reingresos y baja temporal previa cuando existe evidencia.",
        formatos_soportados=(RegistroExportacion.FORMATO_XLSX,),
        implementado=True,
        requiere_objeto=False,
        roles_sugeridos=tuple(sorted(ROLES_ADMIN | ROLES_ESTADISTICA | ROLES_JEFATURA_CARRERA | ROLES_JEFATURA_ACADEMICA | ROLES_JEFATURA_PEDAGOGICA)),
    ...
    ExportacionCatalogoItem(
        codigo=RegistroExportacion.TIPO_REPORTE_EGRESADOS_EGRESABLES,
        nombre="Egresables y egresados",
        descripcion="Reporte derivado de situación actual y evidencia disponible de egreso.",
        formatos_soportados=(RegistroExportacion.FORMATO_XLSX,),
        implementado=True,
        requiere_objeto=False,
        roles_sugeridos=tuple(sorted(ROLES_ADMIN | ROLES_ESTADISTICA | ROLES_JEFATURA_CARRERA | ROLES_JEFATURA_ACADEMICA | ROLES_JEFATURA_PEDAGOGICA)),
        bloque_origen="9I",
        nota="XLSX implementado en Bloque 9I-M-E. No inventa egreso si solo hay condición egresable.",
    ),
    ExportacionCatalogoItem(
        codigo=RegistroExportacion.TIPO_REPORTE_SITUACION_ACADEMICA_AGREGADO,
        nombre="Situación académica agregada",
        ...
        roles_sugeridos=tuple(sorted(ROLES_ADMIN | ROLES_ESTADISTICA | ROLES_JEFATURA_CARRERA | ROLES_JEFATURA_ACADEMICA | ROLES_JEFATURA_PEDAGOGICA)),
        bloque_origen="9I",
        nota="XLSX implementado en Bloque 9I-M-E. Reporte agregado sin nombres.",
    ),
    ExportacionCatalogoItem(
    ...
    ExportacionCatalogoItem(
        ...
        roles_sugeridos=tuple(sorted(ROLES_ADMIN | ROLES_ESTADISTICA | ROLES_JEFATURA_CARRERA | ROLES_JEFATURA_ACADEMICA)),
        bloque_origen="9M",
        nota="XLSX implementado en Bloque 9I-M-E. Solo reporta evidencia; no aplica movimientos.",
    ),
    ExportacionCatalogoItem(
        codigo=RegistroExportacion.TIPO_REPORTE_CAMBIOS_GRUPO,
        nombre="Cambios de grupo",
        descripcion="Reporte específico de movimientos académicos de cambio de grupo.",
        formatos_soportados=(RegistroExportacion.FORMATO_XLSX,),
        implementado=True,
        requiere_objeto=False,
        roles_sugeridos=tuple(sorted(ROLES_ADMIN | ROLES_ESTADISTICA | ROLES_JEFATURA_CARRERA | ROLES_JEFATURA_ACADEMICA)),
        bloque_origen="9M",
        nota="XLSX implementado en Bloque 9I-M-E. No registra intentos fallidos si no existen como movimiento.",
    ),
    ExportacionCatalogoItem(
        codigo=RegistroExportacion.TIPO_REPORTE_HISTORIAL_ACADEMICO_INTERNO,
        nombre="Historial académico interno institucional",
        descripcion="Reporte nominal de historial interno filtrado por ámbito institucional.",
        formatos_soportados=(RegistroExportacion.FORMATO_XLSX,),
        implementado=True,
        requiere_objeto=False,
        roles_sugeridos=tuple(sorted(ROLES_ADMIN | ROLES_ESTADISTICA | ROLES_JEFATURA_CARRERA | ROLES_JEFATURA_ACADEMICA | ROLES_JEFATURA_PEDAGOGICA)),
        bloque_origen="9E",
        nota="XLSX implementado en Bloque 9I-M-E. No sustituye kárdex oficial.",
    ),
    ExportacionCatalogoItem(
