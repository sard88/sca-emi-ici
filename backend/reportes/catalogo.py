...
CATALOGO_EXPORTACIONES = (
    ExportacionCatalogoItem(
        ...
        bloque_origen="9B",
        nota="La generación PDF/Excel real queda para Bloque 9B.",
    ),
    ExportacionCatalogoItem(
        ...
        roles_sugeridos=tuple(sorted(ROLES_ADMIN | ROLES_ESTADISTICA | ROLES_JEFATURA_CARRERA | ROLES_JEFATURA_ACADEMICA | {ROL_DOCENTE})),
        bloque_origen="9B",
        nota="Pendiente de plantilla oficial y generador documental.",
    ),
    ExportacionCatalogoItem(
        ...
        roles_sugeridos=tuple(sorted(ROLES_ADMIN | ROLES_ESTADISTICA | ROLES_JEFATURA_CARRERA | ROLES_JEFATURA_ACADEMICA | {ROL_DOCENTE})),
        bloque_origen="9B",
        nota="Pendiente de reglas de formato oficial.",
    ),
    ExportacionCatalogoItem(
        ...
        bloque_origen="9C",
        nota="No visible ni exportable para discentes.",
    ),
    ExportacionCatalogoItem(
    ...
    ExportacionCatalogoItem(
        ...
        bloque_origen="9F",
        nota="Pendiente de agregados operativos.",
    ),
    ExportacionCatalogoItem(
        ...
        roles_sugeridos=tuple(sorted(ROLES_ADMIN | ROLES_ESTADISTICA | ROLES_JEFATURA_CARRERA | ROLES_JEFATURA_ACADEMICA)),
        bloque_origen="9F",
        nota="Pendiente para reportes operativos.",
    ),
    ExportacionCatalogoItem(
        codigo=RegistroExportacion.TIPO_REPORTE_INCONFORMIDADES,
        nombre="Actas con inconformidades o sin conformidad",
        descripcion="Reporte de conformidades, inconformidades y pendientes informativos.",
        formatos_soportados=(RegistroExportacion.FORMATO_XLSX, RegistroExportacion.FORMATO_PDF),
        implementado=False,
        requiere_objeto=False,
        ...
        bloque_origen="9F",
        nota="La conformidad del discente sigue siendo informativa y no bloqueante.",
    ),
    ExportacionCatalogoItem(
    ...
    ExportacionCatalogoItem(
        ...
        roles_sugeridos=tuple(sorted(ROLES_ADMIN | ROLES_ESTADISTICA | ROLES_JEFATURA_CARRERA | ROLES_JEFATURA_ACADEMICA)),
        bloque_origen="9F",
        nota="Pendiente de consolidación de bitácora de actas.",
    ),
    ExportacionCatalogoItem(
        ...
        bloque_origen="9A",
        nota="En 9A queda disponible la auditoría metadata; no se genera archivo final.",
    ),
    ExportacionCatalogoItem(
