...
CATALOGO_EXPORTACIONES = (
    ...
    ExportacionCatalogoItem(
        ...
        descripcion="Familia de reportes de desempeño: aprobados, reprobados, promedios, exentos y aprovechamiento.",
        formatos_soportados=(RegistroExportacion.FORMATO_XLSX,),
        implementado=True,
        requiere_objeto=False,
        roles_sugeridos=tuple(sorted(ROLES_ADMIN | ROLES_ESTADISTICA | ROLES_JEFATURA_CARRERA | ROLES_JEFATURA_ACADEMICA | ROLES_JEFATURA_PEDAGOGICA)),
        bloque_origen="9G",
        nota="Implementado en Bloque 9G-H como familia de endpoints XLSX. PDF queda pendiente salvo subbloques posteriores.",
    ),
    ExportacionCatalogoItem(
        codigo=RegistroExportacion.TIPO_REPORTE_APROBADOS_REPROBADOS,
        nombre="Aprobados y reprobados",
        descripcion="Indicadores agregados de aprobación y reprobación por grupo, asignatura y periodo.",
        formatos_soportados=(RegistroExportacion.FORMATO_XLSX,),
        implementado=True,
        requiere_objeto=False,
        roles_sugeridos=tuple(sorted(ROLES_ADMIN | ROLES_ESTADISTICA | ROLES_JEFATURA_CARRERA | ROLES_JEFATURA_ACADEMICA | ROLES_JEFATURA_PEDAGOGICA)),
        bloque_origen="9G",
        nota="XLSX implementado en Bloque 9G-H con resultados oficiales consolidados.",
    ),
    ExportacionCatalogoItem(
        codigo=RegistroExportacion.TIPO_REPORTE_PROMEDIOS_ACADEMICOS,
        nombre="Promedios académicos",
        ...
        roles_sugeridos=tuple(sorted(ROLES_ADMIN | ROLES_ESTADISTICA | ROLES_JEFATURA_CARRERA | ROLES_JEFATURA_ACADEMICA | ROLES_JEFATURA_PEDAGOGICA)),
        bloque_origen="9G",
        nota="XLSX implementado en Bloque 9G-H. No incluye gráficas en esta fase.",
    ),
    ExportacionCatalogoItem(
        codigo=RegistroExportacion.TIPO_REPORTE_DISTRIBUCION_CALIFICACIONES,
        nombre="Distribución de calificaciones",
        descripcion="Distribución de calificaciones por rangos institucionales.",
        formatos_soportados=(RegistroExportacion.FORMATO_XLSX,),
        implementado=True,
        requiere_objeto=False,
        roles_sugeridos=tuple(sorted(ROLES_ADMIN | ROLES_ESTADISTICA | ROLES_JEFATURA_CARRERA | ROLES_JEFATURA_ACADEMICA | ROLES_JEFATURA_PEDAGOGICA)),
        bloque_origen="9G",
        nota="XLSX implementado en Bloque 9G-H; datos preparados para análisis posterior.",
    ),
    ExportacionCatalogoItem(
        codigo=RegistroExportacion.TIPO_REPORTE_EXENTOS,
        nombre="Exentos por asignatura",
        ...
        roles_sugeridos=tuple(sorted(ROLES_ADMIN | ROLES_ESTADISTICA | ROLES_JEFATURA_CARRERA | ROLES_JEFATURA_ACADEMICA | ROLES_JEFATURA_PEDAGOGICA)),
        bloque_origen="9G",
        nota="XLSX implementado en Bloque 9G-H. Exento se refiere al examen final, no a toda la evaluación.",
    ),
    ExportacionCatalogoItem(
        codigo=RegistroExportacion.TIPO_REPORTE_DESEMPENO_DOCENTE,
        nombre="Desempeño por docente",
        descripcion="Indicadores de desempeño por docente, asignatura y grupo.",
        formatos_soportados=(RegistroExportacion.FORMATO_XLSX,),
        implementado=True,
        requiere_objeto=False,
        roles_sugeridos=tuple(sorted(ROLES_ADMIN | ROLES_ESTADISTICA | ROLES_JEFATURA_CARRERA | ROLES_JEFATURA_ACADEMICA | ROLES_JEFATURA_PEDAGOGICA)),
        bloque_origen="9G",
        nota="XLSX implementado en Bloque 9G-H para perfiles institucionales; docente no ve comparativos globales.",
    ),
    ExportacionCatalogoItem(
        codigo=RegistroExportacion.TIPO_REPORTE_DESEMPENO_COHORTE,
        nombre="Desempeño por carrera y antigüedad",
        ...
        roles_sugeridos=tuple(sorted(ROLES_ADMIN | ROLES_ESTADISTICA | ROLES_JEFATURA_CARRERA | ROLES_JEFATURA_ACADEMICA | ROLES_JEFATURA_PEDAGOGICA)),
        bloque_origen="9G",
        nota="XLSX implementado en Bloque 9G-H con agregados institucionales.",
    ),
    ExportacionCatalogoItem(
        codigo=RegistroExportacion.TIPO_REPORTE_REPROBADOS_NOMINAL,
        nombre="Reprobados nominal",
        descripcion="Seguimiento nominal autorizado de discentes con resultado reprobatorio vigente.",
        formatos_soportados=(RegistroExportacion.FORMATO_XLSX,),
        implementado=True,
        requiere_objeto=False,
        roles_sugeridos=tuple(sorted(ROLES_ADMIN | ROLES_ESTADISTICA | ROLES_JEFATURA_CARRERA | ROLES_JEFATURA_ACADEMICA | ROLES_JEFATURA_PEDAGOGICA)),
        bloque_origen="9G",
        nota="XLSX implementado en Bloque 9G-H. No muestra matrícula militar por defecto.",
    ),
    ExportacionCatalogoItem(
        codigo=RegistroExportacion.TIPO_CUADRO_APROVECHAMIENTO,
        nombre="Cuadro de aprovechamiento académico",
        descripcion="Clasificación de mejores promedios por rangos de aprovechamiento.",
        formatos_soportados=(RegistroExportacion.FORMATO_XLSX,),
        implementado=True,
        requiere_objeto=False,
        roles_sugeridos=tuple(sorted(ROLES_ADMIN | ROLES_ESTADISTICA | ROLES_JEFATURA_CARRERA | ROLES_JEFATURA_ACADEMICA | ROLES_JEFATURA_PEDAGOGICA)),
        bloque_origen="9H",
        nota="XLSX implementado en Bloque 9G-H. PDF desde plantilla XLSX queda pendiente para una iteración posterior.",
    ),
    ExportacionCatalogoItem(
